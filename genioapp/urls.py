...
urlpatterns = [
    ...
    path(
        "create_credentials/<int:student_id>/",
        views.create_credentials,
        name="create_credentials",
    ),
    path(
        "viewinsavailability/", views.view_ins_availability, name="viewinsavailability"
    ),
    path(
        "create_course_session/",
        views.create_course_session,
